...
public class ExposeBankStatePlugin extends Plugin {

  @Inject private Gson gson;
  @Inject private Client client;

  @Inject private ExposeBankStateConfig config;
  ...
  @Provides
  ExposeBankStateConfig provideConfig(ConfigManager configManager) {
    return configManager.getConfig(ExposeBankStateConfig.class);
  }
  ...
  protected void startUp() throws Exception {
    ...
    restartServer();
    log.info(
        "Expose Bank State started. HTTP enabled={} port={}", config.enableHttp(), config.port());
  }
